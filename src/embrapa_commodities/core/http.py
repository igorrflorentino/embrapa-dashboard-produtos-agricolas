...
:class:`embrapa_commodities.core.SourceTransientError` so cross-source
...
DEFAULT_HEADERS: dict[str, str] = {
    "Connection": "close",
    "User-Agent": "embrapa-commodities/0.1",
}
...
def get_drained(
    ...
    *,
    ...
    - ``transient_exc`` should derive from
      :class:`embrapa_commodities.core.SourceTransientError` (see module
