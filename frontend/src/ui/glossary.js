...
const GLOSSARY = {
  ibge_pevs: {
    ...
    terms: [
      ...
      { term: 'Castanha-do-pará', cat: 'Commodity', tag: '49101', short: 'Semente de Bertholletia excelsa, principal produto extrativista da Amazônia. Unidade: toneladas.' },
      { term: 'Açaí (fruto)',     cat: 'Commodity', tag: '49103', short: 'Fruto da palmeira Euterpe oleracea. Inclui açaí de várzea e plantios manejados como extrativos.' },
      { term: 'Erva-mate',        cat: 'Commodity', tag: '49108', short: 'Folhas e ramos de Ilex paraguariensis para fabricação de chá e chimarrão. Concentrada no Sul.' },
      { term: 'Madeira em tora',  cat: 'Commodity', tag: '49215', short: 'Toras de espécies nativas. Unidade: m³. Sujeita a controle de licenciamento ambiental.' },
      { term: 'Lenha',            cat: 'Commodity', tag: '49216', short: 'Madeira para combustão direta. Unidade: m³. Principal item em volume da PEVS.' },
  ...
  ibge_pam: {
    ...
    terms: [
      ...
      { term: 'Soja (grão)',   cat: 'Commodity', tag: '54011', short: 'Principal lavoura brasileira em área e valor. Concentrada no Centro-Oeste e Sul.' },
      { term: 'Milho (grão)',  cat: 'Commodity', tag: '54012', short: 'Primeira e segunda safra (milho safrinha). Forte em MT, PR e GO.' },
      { term: 'Café (grão)',   cat: 'Commodity', tag: '54013', short: 'Lavoura permanente; arábica e conilon. Concentrado em MG, ES e SP.' },
  ...
  ibge_ppm: {
    ...
    terms: [
      ...
      { term: 'Leite',     cat: 'Commodity', tag: '2682', short: 'Produção em mil litros (família volume). Concentrada em MG, RS e PR.' },
      { term: 'Ovos de galinha', cat: 'Commodity', tag: '2685', short: 'Produção em mil dúzias (família contagem).' },
